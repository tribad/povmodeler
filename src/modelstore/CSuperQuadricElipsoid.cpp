// *************************************************************************************************************
//
//  Modul-Name     : CSuperQuadricElipsoid.cpp
//
 ...
 */
static std::map<objectid_t, CSuperQuadricElipsoid*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-superquadricelipsoid
// End-Of-UDC: save-superquadricelipsoid
    return (result);
}
...
static int setvalue(tSimObj * obj, valueid_t  valueid, valueindex_t  valueindex, const tVariant& value) {
    int err = 0;
    CSuperQuadricElipsoid* superquadricelipsoid_var = (CSuperQuadricElipsoid*)obj;
...
static void init_object(tSimObj * obj, uint64_t  aCycle) {
    CSuperQuadricElipsoid* thisobj = (CSuperQuadricElipsoid*)obj;
    /*
...
//
// **************************************************************************
bool CSuperQuadricElipsoid::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* CSuperQuadricElipsoid::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_superquadricelipsoid_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_superquadricelipsoid_obj(objectid_t  oid) {
    CSuperQuadricElipsoid* newsuperquadricelipsoid = new CSuperQuadricElipsoid;

    if (newsuperquadricelipsoid != 0) {
        tSimObj* newobj = newsuperquadricelipsoid;

        newobj->type        = IDO_SUPERQUADRICELIPSOID;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, CSuperQuadricElipsoid*>(oid, newsuperquadricelipsoid));
        }
    } else {
    }
    return ((tSimObj*)newsuperquadricelipsoid);
}
// **************************************************************************
//
//  Method-Name   : create_new_superquadricelipsoid_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_superquadricelipsoid_obj(objectid_t  oid) {
    CSuperQuadricElipsoid* newsuperquadricelipsoid = new CSuperQuadricElipsoid;
    ...
    if (newsuperquadricelipsoid != 0) {
        ...
        stdb_createobj(oid, IDO_SUPERQUADRICELIPSOID);
        //
...
// **************************************************************************
//
//  Method-Name   : create_new_superquadricelipsoid_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_superquadricelipsoid_obj_from_template(templateid_t  tid, objectid_t  oid) {
    CSuperQuadricElipsoid* newsuperquadricelipsoid = 0;
    std::map<objectid_t, CSuperQuadricElipsoid*>::iterator found;

    found = t_store.find(tid);
    if (found != t_store.end()) {
        newsuperquadricelipsoid = new CSuperQuadricElipsoid;
        if (newsuperquadricelipsoid != 0) {
            tSimObj* newobj = newsuperquadricelipsoid;
...
tObjLib superquadricelipsoid_factory= {0, 0, 0, IDO_SUPERQUADRICELIPSOID, create_superquadricelipsoid_obj, create_new_superquadricelipsoid_obj, create_new_superquadricelipsoid_obj_from_template};
