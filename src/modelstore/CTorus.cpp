 ...
 */
static std::map<objectid_t, CTorus*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-torus
// End-Of-UDC: save-torus
    return (result);
}
...
//
// **************************************************************************
bool CTorus::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* CTorus::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_torus_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_torus_obj(objectid_t  oid) {
    CTorus* newtorus = new CTorus;

    if (newtorus != 0) {
        tSimObj* newobj = newtorus;

        newobj->type        = IDO_TORUS;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, CTorus*>(oid, newtorus));
        }
    } else {
    }
    return ((tSimObj*)newtorus);
}
// **************************************************************************
//
//  Method-Name   : create_new_torus_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_torus_obj(objectid_t  oid) {
    CTorus* newtorus = new CTorus;
...
// **************************************************************************
//
//  Method-Name   : create_new_torus_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_torus_obj_from_template(templateid_t  tid, objectid_t  oid) {
    CTorus* newtorus = 0;
    std::map<objectid_t, CTorus*>::iterator found;
...
tObjLib torus_factory= {0, 0, 0, IDO_TORUS, create_torus_obj, create_new_torus_obj, create_new_torus_obj_from_template};
