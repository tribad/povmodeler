// *************************************************************************************************************
//
//  Modul-Name     : CSurfaceOfRevolution.cpp
//
 ...
 */
static std::map<objectid_t, CSurfaceOfRevolution*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-surfaceofrevolution
// End-Of-UDC: save-surfaceofrevolution
    return (result);
}
...
static int setvalue(tSimObj * obj, valueid_t  valueid, valueindex_t  valueindex, const tVariant& value) {
    int err = 0;
    CSurfaceOfRevolution* surfaceofrevolution_var = (CSurfaceOfRevolution*)obj;
...
static void init_object(tSimObj * obj, uint64_t  aCycle) {
    CSurfaceOfRevolution* thisobj = (CSurfaceOfRevolution*)obj;
    /*
...
//
// **************************************************************************
bool CSurfaceOfRevolution::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* CSurfaceOfRevolution::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_surfaceofrevolution_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_surfaceofrevolution_obj(objectid_t  oid) {
    CSurfaceOfRevolution* newsurfaceofrevolution = new CSurfaceOfRevolution;

    if (newsurfaceofrevolution != 0) {
        tSimObj* newobj = newsurfaceofrevolution;

        newobj->type        = IDO_SURFACEOFREVOLUTION;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, CSurfaceOfRevolution*>(oid, newsurfaceofrevolution));
        }
    } else {
    }
    return ((tSimObj*)newsurfaceofrevolution);
}
// **************************************************************************
//
//  Method-Name   : create_new_surfaceofrevolution_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_surfaceofrevolution_obj(objectid_t  oid) {
    CSurfaceOfRevolution* newsurfaceofrevolution = new CSurfaceOfRevolution;
    ...
    if (newsurfaceofrevolution != 0) {
        ...
        stdb_createobj(oid, IDO_SURFACEOFREVOLUTION);
        //
...
// **************************************************************************
//
//  Method-Name   : create_new_surfaceofrevolution_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_surfaceofrevolution_obj_from_template(templateid_t  tid, objectid_t  oid) {
    CSurfaceOfRevolution* newsurfaceofrevolution = 0;
    std::map<objectid_t, CSurfaceOfRevolution*>::iterator found;

    found = t_store.find(tid);
    if (found != t_store.end()) {
        newsurfaceofrevolution = new CSurfaceOfRevolution;
        if (newsurfaceofrevolution != 0) {
            tSimObj* newobj = newsurfaceofrevolution;
...
tObjLib surfaceofrevolution_factory= {0, 0, 0, IDO_SURFACEOFREVOLUTION, create_surfaceofrevolution_obj, create_new_surfaceofrevolution_obj, create_new_surfaceofrevolution_obj_from_template};
