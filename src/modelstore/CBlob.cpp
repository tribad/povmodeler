 ...
 */
static std::map<objectid_t, CBlob*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-blob
// End-Of-UDC: save-blob
    return (result);
}
...
//
// **************************************************************************
bool CBlob::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* CBlob::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_blob_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_blob_obj(objectid_t  oid) {
    CBlob* newblob = new CBlob;

    if (newblob != 0) {
        tSimObj* newobj = newblob;

        newobj->type        = IDO_BLOB;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, CBlob*>(oid, newblob));
        }
    } else {
    }
    return ((tSimObj*)newblob);
}
// **************************************************************************
//
//  Method-Name   : create_new_blob_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_blob_obj(objectid_t  oid) {
    CBlob* newblob = new CBlob;
...
// **************************************************************************
//
//  Method-Name   : create_new_blob_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_blob_obj_from_template(templateid_t  tid, objectid_t  oid) {
    CBlob* newblob = 0;
    std::map<objectid_t, CBlob*>::iterator found;
...
tObjLib blob_factory= {0, 0, 0, IDO_BLOB, create_blob_obj, create_new_blob_obj, create_new_blob_obj_from_template};
