 ...
 */
static std::map<objectid_t, UVMapping*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-uvmapping
// End-Of-UDC: save-uvmapping
    return (result);
}
...
static int setvalue(tSimObj * obj, valueid_t  valueid, valueindex_t  valueindex, const tVariant& value) {
    int err = 0;
    UVMapping* uvmapping_var = (UVMapping*)obj;
...
static void init_object(tSimObj * obj, uint64_t  aCycle) {
    UVMapping* thisobj = (UVMapping*)obj;
    /*
...
//
// **************************************************************************
bool UVMapping::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* UVMapping::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_uvmapping_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_uvmapping_obj(objectid_t  oid) {
    UVMapping* newuvmapping = new UVMapping;

    if (newuvmapping != 0) {
        tSimObj* newobj = newuvmapping;

        newobj->type        = IDO_UVMAPPING;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, UVMapping*>(oid, newuvmapping));
        }
    } else {
    }
    return ((tSimObj*)newuvmapping);
}
// **************************************************************************
//
//  Method-Name   : create_new_uvmapping_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_uvmapping_obj(objectid_t  oid) {
    UVMapping* newuvmapping = new UVMapping;
    ...
    if (newuvmapping != 0) {
        ...
        stdb_createobj(oid, IDO_UVMAPPING);
        //
...
// **************************************************************************
//
//  Method-Name   : create_new_uvmapping_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_uvmapping_obj_from_template(templateid_t  tid, objectid_t  oid) {
    UVMapping* newuvmapping = 0;
    std::map<objectid_t, UVMapping*>::iterator found;

    found = t_store.find(tid);
    if (found != t_store.end()) {
        newuvmapping = new UVMapping;
        if (newuvmapping != 0) {
            tSimObj* newobj = newuvmapping;
...
tObjLib uvmapping_factory= {0, 0, 0, IDO_UVMAPPING, create_uvmapping_obj, create_new_uvmapping_obj, create_new_uvmapping_obj_from_template};
