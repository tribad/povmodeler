 ...
 */
static std::map<objectid_t, CMesh2*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-mesh2
// End-Of-UDC: save-mesh2
    return (result);
}
...
//
// **************************************************************************
bool CMesh2::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* CMesh2::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_mesh2_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_mesh2_obj(objectid_t  oid) {
    CMesh2* newmesh2 = new CMesh2;

    if (newmesh2 != 0) {
        tSimObj* newobj = newmesh2;

        newobj->type        = IDO_MESH2;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, CMesh2*>(oid, newmesh2));
        }
    } else {
    }
    return ((tSimObj*)newmesh2);
}
// **************************************************************************
//
//  Method-Name   : create_new_mesh2_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_mesh2_obj(objectid_t  oid) {
    CMesh2* newmesh2 = new CMesh2;
...
// **************************************************************************
//
//  Method-Name   : create_new_mesh2_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_mesh2_obj_from_template(templateid_t  tid, objectid_t  oid) {
    CMesh2* newmesh2 = 0;
    std::map<objectid_t, CMesh2*>::iterator found;
...
tObjLib mesh2_factory= {0, 0, 0, IDO_MESH2, create_mesh2_obj, create_new_mesh2_obj, create_new_mesh2_obj_from_template};
