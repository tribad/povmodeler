 ...
 */
static std::map<objectid_t, CCone*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-cone
// End-Of-UDC: save-cone
    return (result);
}
...
//
// **************************************************************************
bool CCone::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* CCone::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_cone_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_cone_obj(objectid_t  oid) {
    CCone* newcone = new CCone;

    if (newcone != 0) {
        tSimObj* newobj = newcone;

        newobj->type        = IDO_CONE;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, CCone*>(oid, newcone));
        }
    } else {
    }
    return ((tSimObj*)newcone);
}
// **************************************************************************
//
//  Method-Name   : create_new_cone_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_cone_obj(objectid_t  oid) {
    CCone* newcone = new CCone;
...
// **************************************************************************
//
//  Method-Name   : create_new_cone_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_cone_obj_from_template(templateid_t  tid, objectid_t  oid) {
    CCone* newcone = 0;
    std::map<objectid_t, CCone*>::iterator found;
...
tObjLib cone_factory= {0, 0, 0, IDO_CONE, create_cone_obj, create_new_cone_obj, create_new_cone_obj_from_template};
