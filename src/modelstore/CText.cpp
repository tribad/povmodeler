 ...
 */
static std::map<objectid_t, CText*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-text
// End-Of-UDC: save-text
    return (result);
}
...
//
// **************************************************************************
bool CText::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* CText::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_text_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_text_obj(objectid_t  oid) {
    CText* newtext = new CText;

    if (newtext != 0) {
        tSimObj* newobj = newtext;

        newobj->type        = IDO_TEXT;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, CText*>(oid, newtext));
        }
    } else {
    }
    return ((tSimObj*)newtext);
}
// **************************************************************************
//
//  Method-Name   : create_new_text_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_text_obj(objectid_t  oid) {
    CText* newtext = new CText;
...
// **************************************************************************
//
//  Method-Name   : create_new_text_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_text_obj_from_template(templateid_t  tid, objectid_t  oid) {
    CText* newtext = 0;
    std::map<objectid_t, CText*>::iterator found;
...
tObjLib text_factory= {0, 0, 0, IDO_TEXT, create_text_obj, create_new_text_obj, create_new_text_obj_from_template};
