 ...
 */
static std::map<objectid_t, CBox*> t_store;
/*
 *
...
//
// **************************************************************************
bool CBox::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* CBox::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_box_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_box_obj(objectid_t  oid) {
    CBox* newbox = new CBox;

    if (newbox != 0) {
        tSimObj* newobj = newbox;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, CBox*>(oid, newbox));
        }
    } else {
    }
    return ((tSimObj*)newbox);
}
// **************************************************************************
//
//  Method-Name   : create_new_box_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_box_obj(objectid_t  oid) {
    CBox* newbox = new CBox;
...
// **************************************************************************
//
//  Method-Name   : create_new_box_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_box_obj_from_template(templateid_t  tid, objectid_t  oid) {
    CBox* newbox = 0;
    std::map<objectid_t, CBox*>::iterator found;
...
tObjLib box_factory= {0, 0, 0, IDO_BOX, create_box_obj, create_new_box_obj, create_new_box_obj_from_template};
