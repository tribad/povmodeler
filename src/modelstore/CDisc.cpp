 ...
 */
static std::map<objectid_t, CDisc*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-disc
// End-Of-UDC: save-disc
    return (result);
}
...
//
// **************************************************************************
bool CDisc::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* CDisc::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_disc_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_disc_obj(objectid_t  oid) {
    CDisc* newdisc = new CDisc;

    if (newdisc != 0) {
        tSimObj* newobj = newdisc;

        newobj->type        = IDO_DISC;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, CDisc*>(oid, newdisc));
        }
    } else {
    }
    return ((tSimObj*)newdisc);
}
// **************************************************************************
//
//  Method-Name   : create_new_disc_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_disc_obj(objectid_t  oid) {
    CDisc* newdisc = new CDisc;
...
// **************************************************************************
//
//  Method-Name   : create_new_disc_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_disc_obj_from_template(templateid_t  tid, objectid_t  oid) {
    CDisc* newdisc = 0;
    std::map<objectid_t, CDisc*>::iterator found;
...
tObjLib disc_factory= {0, 0, 0, IDO_DISC, create_disc_obj, create_new_disc_obj, create_new_disc_obj_from_template};
