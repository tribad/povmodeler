 ...
 */
static std::map<objectid_t, COvus*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-ovus
// End-Of-UDC: save-ovus
    return (result);
}
...
//
// **************************************************************************
bool COvus::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* COvus::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_ovus_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_ovus_obj(objectid_t  oid) {
    COvus* newovus = new COvus;

    if (newovus != 0) {
        tSimObj* newobj = newovus;

        newobj->type        = IDO_OVUS;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, COvus*>(oid, newovus));
        }
    } else {
    }
    return ((tSimObj*)newovus);
}
// **************************************************************************
//
//  Method-Name   : create_new_ovus_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_ovus_obj(objectid_t  oid) {
    COvus* newovus = new COvus;
...
// **************************************************************************
//
//  Method-Name   : create_new_ovus_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_ovus_obj_from_template(templateid_t  tid, objectid_t  oid) {
    COvus* newovus = 0;
    std::map<objectid_t, COvus*>::iterator found;
...
tObjLib ovus_factory= {0, 0, 0, IDO_OVUS, create_ovus_obj, create_new_ovus_obj, create_new_ovus_obj_from_template};
