 ...
 */
static std::map<objectid_t, CLathe*> t_store;
/*
 *
...
static int save(tSimObj* obj, uint64_t aCycle, ... ) {
    int result = 0;
// User-Defined-Code: save-lathe
// End-Of-UDC: save-lathe
    return (result);
}
...
//
// **************************************************************************
bool CLathe::DefaultSigHandler(tSig *sig) {
    bool retval = false;
...
//
// **************************************************************************
tMsg* CLathe::DefaultMsgHandler(tMsg *msg) {
    tMsg* retval = 0;
...
// **************************************************************************
//
//  Method-Name   : create_lathe_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_lathe_obj(objectid_t  oid) {
    CLathe* newlathe = new CLathe;

    if (newlathe != 0) {
        tSimObj* newobj = newlathe;

        newobj->type        = IDO_LATHE;
        newobj->objid       = oid;
        newobj->parent      = 0;
        ...
        if (0xc0000000 & oid) {
            t_store.insert(std::pair<templateid_t, CLathe*>(oid, newlathe));
        }
    } else {
    }
    return ((tSimObj*)newlathe);
}
// **************************************************************************
//
//  Method-Name   : create_new_lathe_obj()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_lathe_obj(objectid_t  oid) {
    CLathe* newlathe = new CLathe;
...
// **************************************************************************
//
//  Method-Name   : create_new_lathe_obj_from_template()
//
//  Generated source code.
//
// **************************************************************************
static tSimObj* create_new_lathe_obj_from_template(templateid_t  tid, objectid_t  oid) {
    CLathe* newlathe = 0;
    std::map<objectid_t, CLathe*>::iterator found;
...
tObjLib lathe_factory= {0, 0, 0, IDO_LATHE, create_lathe_obj, create_new_lathe_obj, create_new_lathe_obj_from_template};
